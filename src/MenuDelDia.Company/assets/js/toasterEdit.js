...
.service('toaster', ['$rootScope', function ($rootScope) {
    ...
    this.success = function (title, body, timeout, bodyOutputType, id, clickHandler, customParams) {
        this.pop('success', title, body, timeout, bodyOutputType, id, clickHandler, customParams);
    };
    this.error = function (title, body, timeout, bodyOutputType, id, clickHandler, customParams) {
        this.pop('error', title, body, timeout, bodyOutputType, id, clickHandler, customParams);
    };
    this.warning = function (title, body, timeout, bodyOutputType, id, clickHandler, customParams) {
        this.pop('warning', title, body, timeout, bodyOutputType, id, clickHandler, customParams);
    };
    this.info = function (title, body, timeout, bodyOutputType, id, clickHandler, customParams) {
        this.pop('info', title, body, timeout, bodyOutputType, id, clickHandler, customParams);
    };
    this.message = function (title, body, timeout, bodyOutputType, id, clickHandler, customParams) {
        this.pop('message', title, body, timeout, bodyOutputType, id, clickHandler, customParams);
    };
    this.list = function (type, title, listItems, timeout) {
        this.pop(type, title, 'listItemsToast.html', timeout, 'template', 'listItemsToast', null, {
            listItems: listItems
        });
    };

    this.pop = function (type, title, body, timeout, bodyOutputType, id, clickHandler, customParams) {
        var toast;
        ...
        $rootScope.$broadcast('toaster-refresh', body);
    ...
    return {
        ...
        '<div  id="toast-container" ng-class="config.position">' +
            '<div ng-repeat="toaster in toasters" class="toast" ng-class="toaster.type" ng-click="click(toaster)" ng-mouseover="stopTimer(toaster)"  ng-mouseout="restartTimer(toaster)">' +
              '<button class="toast-close-button" ng-show="config.closeButton" ng-click="removeToast(toaster.id)">&times;</button>' +
